...
public class CommentandScore_BrandName_Favorite extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_commentand_score__brand_name__style);
        ...
        String t = getResources().getString(R.string.comment);
        this.bar.setTitle(t);
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    else
                    {
                        ...
                        layoutParams.setMargins(marginInDp2,marginInDp,0,0);
        ...
        try
        {
            ...
            JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, savepath, json, new Response.Listener<JSONObject>() {
                ...
                public void onResponse(JSONObject response) {
                    ...
                    Intent i = new Intent(CommentandScore_BrandName_Favorite.this,CommentandScore_BrandName_Favorite.class);
                    startActivity(i);
                }
            }, new Response.ErrorListener() {
                @Override
