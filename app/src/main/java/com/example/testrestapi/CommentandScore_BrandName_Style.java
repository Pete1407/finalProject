...
public class CommentandScore_BrandName_Style extends AppCompatActivity {
        ...
        try
        {
            ...
            JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, savepath, json, new Response.Listener<JSONObject>() {
                ...
                public void onResponse(JSONObject response) {
                    ...
                    Intent i = new Intent(CommentandScore_BrandName_Style.this,CommentandScore_BrandName_Style.class);
                    startActivity(i);
                }
            }, new Response.ErrorListener() {
                @Override
