...
public class CommentandScore_Information_Favorite extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_commentand_score__information__favorite);
        ...
        try
        {
            ...
            JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, savepath, json, new Response.Listener<JSONObject>() {
                ...
                public void onResponse(JSONObject response) {
                    ...
                    Intent i = new Intent(CommentandScore_Information_Favorite.this,CommentandScore_Information_Favorite.class);
                    finish();
                    startActivity(i);
                }
            }, new Response.ErrorListener() {
