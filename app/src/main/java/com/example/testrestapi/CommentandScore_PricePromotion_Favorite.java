...
public class CommentandScore_PricePromotion_Favorite extends AppCompatActivity {
        ...
        try
        {
            ...
            JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, savepath, json, new Response.Listener<JSONObject>() {
                ...
                public void onResponse(JSONObject response) {
                    ...
                    Intent i = new Intent(CommentandScore_PricePromotion_Favorite.this,CommentandScore_PricePromotion_Favorite.class);
                    startActivity(i);
                }
            }, new Response.ErrorListener() {
                @Override
