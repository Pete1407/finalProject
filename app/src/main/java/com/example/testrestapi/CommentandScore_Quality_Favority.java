...
public class CommentandScore_Quality_Favority extends AppCompatActivity {
        ...
        try
        {
            ...
            JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, savepath, json, new Response.Listener<JSONObject>() {
                ...
                public void onResponse(JSONObject response) {
                    ...
                    Intent i = new Intent(CommentandScore_Quality_Favority.this,CommentandScore_Quality_Favority.class);
                    finish();
                    startActivity(i);
                }
            }, new Response.ErrorListener() {
