...
public class CommentandScore_Quality_Style extends AppCompatActivity {
        ...
        try
        {
            ...
            JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, savepath, json, new Response.Listener<JSONObject>() {
                ...
                public void onResponse(JSONObject response) {
                    ...
                    Intent i = new Intent(CommentandScore_Quality_Style.this,CommentandScore_PricePromotion_Style.class);
                    finish();
                    startActivity(i);
                }
            }, new Response.ErrorListener() {
