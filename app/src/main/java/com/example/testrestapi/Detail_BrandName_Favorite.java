...
public class Detail_BrandName_Favorite extends AppCompatActivity {
                            ...
                            JsonObjectRequest image360 = new JsonObjectRequest(Request.Method.GET, getImage360, null, new Response.Listener<JSONObject>() {
                                ...
                                public void onResponse(JSONObject response) {
                                    try
                                    {
                                        ...
                                        System.out.println("Path Image360: "+image);
                                        pathImage360 = image;
                                        Intent i = new Intent(Detail_BrandName_Favorite.this, FullScreen_Image360.class);
            ...
            public void onResponse(JSONObject response) {
                ...
                try
                {
                    ...
                    for(int count=0;count<textth.length();count++)
                    {
                        ...
                        fac[count] = new Facility(textth.getString(count),texten.getString(count),image.getInt(count));
                        list.add(fac[count]);
                    }
    ...
    public void getExpense(View v){
        Intent i = new Intent(Detail_BrandName_Favorite.this,Expense_BrandName_Style.class);
        i.putExtra("dormName",dormName);
        startActivity(i);
    }

    public void getPlace(View v){
        Intent i = new Intent(Detail_BrandName_Favorite.this,ImportantPlace_BrandName_Style.class);
        startActivity(i);
    }

    public void getTravel(View v){
        Intent i = new Intent(Detail_BrandName_Favorite.this,Travel_BrandName_Style.class);
        startActivity(i);
    }

    public void getComment(View v){
        Intent i = new Intent(Detail_BrandName_Favorite.this,CommentandScore_BrandName_Favorite.class);
        startActivity(i);
    }

    public void getGallery(View v){
        Intent i = new Intent(Detail_BrandName_Favorite.this,Gallery_BrandName_Style.class);
        startActivity(i);
    }
