...
public class Detail_Dorm_Information extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.linear_comment = (LinearLayout) findViewById(R.id.commentfromuser);
                            ...
                            JsonObjectRequest image360 = new JsonObjectRequest(Request.Method.GET, getImage360, null, new Response.Listener<JSONObject>() {
                                ...
                                public void onResponse(JSONObject response) {
                                    try
                                    {
                                        ...
                                        pathimage360 = image;
                                        Intent i = new Intent(Detail_Dorm_Information.this, FullScreen_Image360.class);
    ...
    public void goComment(View v){
        Intent intent = new Intent(Detail_Dorm_Information.this,CommentandScore_Information_Style.class);
    ...
    public void showImage(View v){
        Intent i = new Intent(Detail_Dorm_Information.this,Fullscreen_Image.class);
    ...
    public void getGallery(View v){
        Intent i = new Intent(Detail_Dorm_Information.this,Gallery_Information.class);
        startActivity(i);
    }
