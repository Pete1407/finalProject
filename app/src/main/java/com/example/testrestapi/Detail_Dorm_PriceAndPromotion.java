...
public class Detail_Dorm_PriceAndPromotion extends AppCompatActivity implements OnMapReadyCallback{
   ...
   public ArrayList<String> stack = new ArrayList<>();
                            ...
                            JsonObjectRequest image360 = new JsonObjectRequest(Request.Method.GET, getImage360, null, new Response.Listener<JSONObject>() {
                                ...
                                public void onResponse(JSONObject response) {
                                    try
                                    {
                                        ...
                                        pathimage360 = image;
                                        Intent i = new Intent(Detail_Dorm_PriceAndPromotion.this, FullScreen_Image360.class);
            ...
            public void onResponse(JSONObject response) {
                try {
                   ...
                   final double longtitude = response.getDouble("longtitude");
                    ...
                    final int width = 120;
                    BitmapDrawable bitmapdrawable2 = (BitmapDrawable)getResources().getDrawable(R.drawable.pin_dorm_use);
                    ...
                    JsonObjectRequest req2 = new JsonObjectRequest(Request.Method.GET, urlDirection, null, new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            try
                            {
                                ...
                                String walkingPath =  "https://maps.googleapis.com/maps/api/distancematrix/json?units=metric&origins="+latitude+","+longtitude+"&destinations="+faculty.getLatitude()+","+faculty.getLongtitude()+"&mode=walking&key="+newServerKey;
                                ...
                                JsonObjectRequest getd = new JsonObjectRequest(Request.Method.GET,walkingPath, null, new Response.Listener<JSONObject>() {
                                    @Override
                                    public void onResponse(JSONObject response) {
                                        System.out.println("Walking: "+response);

                                        JSONObject obj = response;
                                        try
                                        {
                                            JSONArray rows = obj.getJSONArray("rows");
                                            JSONObject tra = rows.getJSONObject(0);
                                            JSONArray elements = tra.getJSONArray("elements");
                                            JSONObject element = elements.getJSONObject(0);
                                            JSONObject duration = element.getJSONObject("duration");
                                            String timetravel = duration.getString("text");
                                            timeWalking.setText(timetravel);
                                            int red = getResources().getColor(R.color.red);
                                ...
                                String urlDirection2 =  "https://maps.googleapis.com/maps/api/distancematrix/json?units=metric&origins="+latitude+","+longtitude+"&destinations="+faculty.getLatitude()+","+faculty.getLongtitude()+"&mode=driving&key="+newServerKey;
                                ...
                                JsonObjectRequest getd2 = new JsonObjectRequest(Request.Method.GET, urlDirection2, null, new Response.Listener<JSONObject>() {
                                    @Override
                                    public void onResponse(JSONObject response) {
                                        System.out.println("Driving: "+response);
                                        ...
                                        try
                                        {
                                            ...
                                            JSONObject duration = element.getJSONObject("duration");
                                            String timetravel = duration.getString("text");
                                            timeDriving.setText(timetravel);
                                            int red = getResources().getColor(R.color.red);
                             ...
                             /*
                                GoogleDirection.withServerKey(newServerKey)
                                        .from(new LatLng(latitude,longtitude))
                                        .to(new LatLng(faculty.getLatitude(),faculty.getLongtitude()))
                                        ...
                                        .execute(new DirectionCallback() {
                                            ...
                                            public void onDirectionSuccess(Direction direction) {
                                                if(direction.isOK())
                                                {
                                                    ...
                                                    Info distanceinfo = leg.getDuration();
                                                    String duration = distanceinfo.getText();
                                                    timeTransit.setText(duration);
                                                    int red = getResources().getColor(R.color.red);
                              ...
                              */
                                String urlDirection3 =  "https://maps.googleapis.com/maps/api/distancematrix/json?units=metric&origins="+latitude+","+longtitude+"&destinations="+faculty.getLatitude()+","+faculty.getLongtitude()+"&mode=transit&key="+newServerKey;
                                ...
                                JsonObjectRequest getd3 = new JsonObjectRequest(Request.Method.GET, urlDirection3, null, new Response.Listener<JSONObject>() {
                                    @Override
                                    public void onResponse(JSONObject response) {
                                        System.out.println("Transit: "+response);
                                        JSONObject obj = response;
                                        try
                                        {
                                            JSONArray rows = obj.getJSONArray("rows");
                                            ...
                                            JSONObject duration = element.getJSONObject("duration");
                                            String timetravel = duration.getString("text");
                                            timeTransit.setText(timetravel);
                                            int red = getResources().getColor(R.color.red);
                                            timeTransit.setTextColor(red);
                                        }
                                        catch (JSONException e) {
    ...
    public void showPlace(View v){
        Intent i = new Intent(Detail_Dorm_PriceAndPromotion.this,ImportancePlace_PriceandPromotion_Style.class);
        startActivity(i);
    }

    public void showFacility(View v){
        Intent i = new Intent(Detail_Dorm_PriceAndPromotion.this,Facility_PricePromotion_Style.class);
        startActivity(i);
    }
    ...
    public void getGallery(View v){
       Intent i = new Intent(Detail_Dorm_PriceAndPromotion.this,Gallery_PricePromotion.class);
       startActivity(i);
    }
   ...
   public void  showContact(final String dormName){
    ...
    public void commentAndScoreActivity(View v){
        Intent i = new Intent(Detail_Dorm_PriceAndPromotion.this,CommentandScore_PricePromotion_Style.class);
        startActivity(i);
    }

    public void showImage(View v){
        Intent i = new Intent(Detail_Dorm_PriceAndPromotion.this,Fullscreen_Image.class);
