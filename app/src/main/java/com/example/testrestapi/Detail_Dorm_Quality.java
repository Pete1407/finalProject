...
public class Detail_Dorm_Quality extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail__dorm__quality);
        ...
        this.usercomment = (LinearLayout) findViewById(R.id.usercomment);
        this.premiumGrid = (ExpandableHeightGridView) findViewById(R.id.gridview);
        ...
        this.signFavorite.setText(summaryLikeDorm+" "+pressFavorite);
                            ...
                            JsonObjectRequest image360 = new JsonObjectRequest(Request.Method.GET, getImage360, null, new Response.Listener<JSONObject>() {
                                ...
                                public void onResponse(JSONObject response) {
                                    try
                                    {
                                        ...
                                        pathimage360 = image;
                                        Intent i = new Intent(Detail_Dorm_Quality.this, FullScreen_Image360.class);
        ...
        this.getPremium(dormName);


    }

    public void goComment(View v){
        Intent intent = new Intent(Detail_Dorm_Quality.this,CommentandScore_Quality_Style.class);
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, setcommentpath, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    {
                        System.out.println("Ja Aeee");
                        for(int count=0;count<com.length;count++)
                        {
                            System.out.println("com : "+com[count]);
                        }
                    }
                /*
                    if(comment.length() >=4)
                ...
                */
                    ArrayAdapter<CharSequence> adapter = new ArrayAdapter<CharSequence>(getApplicationContext(),android.R.layout.simple_expandable_list_item_1,com){
                        @NonNull
                        @Override
    ...
    public void showImage(View v){
        Intent i = new Intent(Detail_Dorm_Quality.this,Fullscreen_Image.class);
        ...
        JsonObjectRequest indorm = new JsonObjectRequest(Request.Method.GET, pathIndorm, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    {
                        f[count] = new Facility(nameTH.getString(count),nameEN.getString(count),imagecode.getInt(count));
                    ...
                    JsonObjectRequest inroom = new JsonObjectRequest(Request.Method.GET, pathInroom, null, new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            try {
                                ...
                                {
                                    fac[count2] = new Facility(nameth.getString(count2),nameen.getString(count2),imagecode.getInt(count2));
                                    int codee = imagecode.getInt(count2);
                                    String thtext = nameth.getString(count2);
                                    String entext = nameen.getString(count2);
                                 if(langcode == 0)
                                 {
                                     faclist.add(fac[count2]);
                                 }
                                 else
                                 {
                                     faclist.add(fac[count2]);
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, premiumPath, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    PremiumAdapter adapter = new PremiumAdapter(getApplicationContext(),list,langcode);
    ...
    public void getGallery(View v){
        Intent i = new Intent(Detail_Dorm_Quality.this,Gallery_Information.class);
        startActivity(i);
    }
    ...
    public void displayArray(JSONArray array,String dormName){
        ...
        try
        {
            ...
            signFavorite.setText(numberofLike+" "+pressFavorite);
