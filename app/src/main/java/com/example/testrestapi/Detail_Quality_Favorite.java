...
public class Detail_Quality_Favorite extends AppCompatActivity implements OnMapReadyCallback {
                            ...
                            JsonObjectRequest image360 = new JsonObjectRequest(Request.Method.GET, getImage360, null, new Response.Listener<JSONObject>() {
                                ...
                                public void onResponse(JSONObject response) {
                                    try
                                    {
                                        ...
                                        pathimage360 = image;
                                        Intent i = new Intent(Detail_Quality_Favorite.this, FullScreen_Image360.class);
    ...
    public void goComment(View v){
        Intent intent = new Intent(Detail_Quality_Favorite.this,CommentandScore_Quality_Favority.class);
    ...
    public void showImage(View v){
        Intent i = new Intent(Detail_Quality_Favorite.this,Fullscreen_Image.class);
    ...
    public void getGallery(View v){
        Intent i = new Intent(Detail_Quality_Favorite.this,Gallery_Information.class);
        startActivity(i);
    }
