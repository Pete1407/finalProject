...
public class VolleyMultipartRequest_For_Gallery extends Request<JSONObject> {
    ...
    public VolleyMultipartRequest_For_Gallery(String url, Map<String, String> headers,
    ...
    public VolleyMultipartRequest_For_Gallery(int method, String url,
                                  Response.Listener<JSONObject> listener,
                                  Response.ErrorListener errorListener) {
